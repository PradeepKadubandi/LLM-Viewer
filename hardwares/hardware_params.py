...
hardware_params = {
    ...
    "nvidia_V100": {"bandwidth": 900e9, "FP16": 112e12, "INT8": 62e12, "onchip_buffer": 20480e3, "memory_capacity": 32 * GiB},
    # https://images.nvidia.com/aem-dam/en-zz/Solutions/technologies/NVIDIA-ADA-GPU-PROVIZ-Architecture-Whitepaper_1.1.pdf
    "nvidia_A6000": {"bandwidth": 768e9, "FP16": 154.8e12, "INT8": 309.7e12, "INT4": 619.4e12, "onchip_buffer": 21504e3, "memory_capacity": 48 * GiB},
    # https://images.nvidia.com/aem-dam/en-zz/Solutions/technologies/NVIDIA-ADA-GPU-PROVIZ-Architecture-Whitepaper_1.1.pdf
    "nvidia_A6000_Ada": {"bandwidth": 960e9, "FP16": 364.2e12, "INT8": 728.5e12, "INT4": 1457e12, "onchip_buffer": 36352e3, "memory_capacity": 48 * GiB},
    # https://images.nvidia.com/aem-dam/en-zz/Solutions/data-center/nvidia-ampere-architecture-whitepaper.pdf
    # Ampere's SM has 256KB RF, max 164KB Shared Mem
    "nvidia_A100": {"bandwidth": 1555e9, "FP16": 312e12, "INT8": 624e12, "INT4": 1248e12, "onchip_buffer": 27648e3, "memory_capacity": 40 * GiB},  # use 40G data
    "nvidia_A100_40G": {"bandwidth": 1555e9, "FP16": 312e12, "INT8": 624e12, "INT4": 1248e12, "onchip_buffer": 27648e3, "memory_capacity": 40 * GiB},
    "nvidia_A100_80G": {"bandwidth": 2039e9, "FP16": 312e12, "INT8": 624e12, "INT4": 1248e12, "onchip_buffer": 27648e3, "memory_capacity": 80 * GiB},
    "nvidia_A800_80G_SXM": {"bandwidth": 2039e9, "FP16": 312e12, "INT8": 624e12, "INT4": 1248e12, "onchip_buffer": 27648e3, "memory_capacity": 80 * GiB},
    "nvidia_A40": {"bandwidth": 696e9, "FP16": 149.7e12, "INT8": 299.3e12, "INT4": 598.6e12, "onchip_buffer": 21504e3, "memory_capacity": 48 * GiB},
    ...
    "nvidia_H100_SXM": {"bandwidth": 3072e9, "FP16": 1979e12 / 2, "INT8": 3958e12 / 2, "onchip_buffer": 33792e3, "memory_capacity": 80 * GiB},
    "nvidia_H100_PCIe": {"bandwidth": 2048e9, "FP16": 1513e12 / 2, "INT8": 3026e12 / 2, "onchip_buffer": 29184e3, "memory_capacity": 80 * GiB},
    # https://images.nvidia.com/aem-dam/Solutions/Data-Center/l4/nvidia-ada-gpu-architecture-whitepaper-v2.1.pdf
    # Ada SM has 256 KB Register File, and 128 KB of L1/Shared Memory
    "nvidia_L40": {"bandwidth": 864e9, "FP16": 181e12, "INT8": 362e12, "INT4": 724e12, "onchip_buffer": 36352e3, "memory_capacity": 48 * GiB},
    ...
    "intel_13900k": {"bandwidth": 89.6e9, "FP16": 8 * 5.4e9 * (512 / 16), "onchip_buffer": 36e6, "memory_capacity": 128 * GiB},  # DRAM is configurable; default assumption
    ...
    "jetson_orin_nx_16gb": {"bandwidth": 102.4e9, "FP16": 25e12, "INT8": 50e12, "INT4": 100e12, "onchip_buffer": 8 * 256e3, "memory_capacity": 16 * GiB},
    # Jetson AGX Orin 64GB: 2048 Ampere CUDA cores (16 SMs), 275 sparse INT8
    # TOPS, 204.8 GB/s LPDDR5.
    "jetson_agx_orin_64gb": {"bandwidth": 204.8e9, "FP16": 68.75e12, "INT8": 137.5e12, "INT4": 275e12, "onchip_buffer": 16 * 256e3, "memory_capacity": 64 * GiB},
    ...
    "jetson_agx_thor": {"bandwidth": 273e9, "FP16": 258e12, "INT8": 517e12, "INT4": 1035e12, "onchip_buffer": 20 * 256e3, "memory_capacity": 128 * GiB},
}
